...
- Explicit Congestion Notification (ECN): implement [end-to-end QUIC ECN](https://bugzilla.mozilla.org/show_bug.cgi?id=1902065) covering marking, reading, RFC 9000 path validation and Congestion Experienced feedback to the congestion controller, resilient to middlebox interference. ~50% of Firefox Nightly QUIC connections now run on ECN-capable paths.
